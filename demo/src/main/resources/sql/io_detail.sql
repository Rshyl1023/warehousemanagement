...
CREATE TABLE `io_detail`  (
  ...
  `type` enum('IN','OUT') CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL COMMENT '明细进出类型',
  `qty` int NOT NULL COMMENT '进仓或出仓数量',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `uk_io_detail`(`io_no` ASC, `material_code` ASC, `type` ASC) USING BTREE,
...
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_0900_ai_ci COMMENT = '物料进出仓明细表' ROW_FORMAT = Dynamic;
